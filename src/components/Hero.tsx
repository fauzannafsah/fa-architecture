...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <EditableImage
        contentKey="hero.bg_image"
        defaultValue="https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=1920&q=80"
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center lg:px-12">
        ...
        >
          ...
          <EditableText
            ...
            defaultValue="Spesialis Peternakan &amp; Perumahan"
        ...
        <div className="overflow-hidden">
          ...
          >
            <EditableText
              contentKey="hero.heading1"
              defaultValue="Merancang Ruang"
            />
          </motion.h1>
        </div>
        <div className="overflow-hidden">
          ...
          >
            <EditableText
              contentKey="hero.heading2"
              defaultValue="Di Mana"
            />{" "}
            <span className="italic text-terracotta-light">
              <EditableText
                contentKey="hero.heading2_accent"
                defaultValue="Fungsi"
              />
            </span>
          </motion.h1>
        ...
        <div className="overflow-hidden">
          ...
          >
            <EditableText
              contentKey="hero.heading3"
              defaultValue="Bertemu"
            />{" "}
            <span className="italic text-terracotta-light">
              <EditableText
                contentKey="hero.heading3_accent"
                defaultValue="Estetika"
              />
            </span>
          </motion.h1>
        </div>
        ...
        >
          <EditableText
            ...
            defaultValue="Kami menciptakan solusi arsitektur yang menyelaraskan hunian modern dengan keunggulan pertanian — dari fasilitas peternakan canggih hingga rumah yang hangat dan berkelanjutan."
            as="p"
        ...
        >
          <a
            href={getWhatsAppUrl(WA_MESSAGES.hero, waNumber)}
            target="_blank"
